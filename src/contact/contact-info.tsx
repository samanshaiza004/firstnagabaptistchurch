...
const contactDetails = [
  ...
  },
  {
    icon: Clock,
    title: "Service Times",
    primary: "Sunday Worship: 2:00 PM",
  ...
  },
  {
    icon: Mail,
    title: "Email",
    primary: "info@firstnagabaptist.org",
    link: "mailto:info@firstnagabaptist.org",
  },
  {
    icon: Phone,
    title: "Phone",
    primary: "(817) 555-0123",
    link: "tel:+18175550123",
  },
]
  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-8">
        Find us at our worship location or reach out through any of the channels below.
      </p>
            ...
            <CardContent className="p-4 flex gap-4">
              ...
              <div>
                ...
                {detail.link ? (
                  ...
                  <p className="font-semibold text-foreground">{detail.primary}</p>
                )}
                {detail.secondary && <p className="text-sm text-muted-foreground">{detail.secondary}</p>}
                {detail.note && <p className="text-sm text-muted-foreground mt-2 leading-relaxed">{detail.note}</p>}
              </div>
            </CardContent>
          </Card>
        ))}
      ...
      <div className="mt-8 bg-primary text-primary-foreground rounded-lg p-6">
        <h3 className="font-serif text-lg font-semibold mb-4">Join Us This Sunday</h3>
        <div className="space-y-3 text-sm">
          ...
          <div className="flex justify-between items-center border-b border-primary-foreground/20 pb-2">
            <span className="text-primary-foreground/80">Fellowship Lunch</span>
            <span className="font-semibold">After Service</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-primary-foreground/80">Prayer Meeting (Wed)</span>
