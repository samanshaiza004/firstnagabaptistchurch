...
export const localContent: CmsContent = {
  ...
  pages: {
    home: {
      ...
      primaryCta: { label: "Plan Your Sunday", href: "/visit" }, secondaryCta: { label: "Read Our Story", href: "/about" },
    ...
    about: {
      ...
      objectivesEyebrow: "Our Mission", objectivesTitle: "Our Main Objectives", objectivesDescription: "These objectives guide our ministry and reflect our commitment to serving God and our community.", objectivesCta: { label: "Plan a Visit", href: "/visit" },
    },
  ...
  gallery: galleryData.map((photo) => ({ id: photo.id, title: photo.title, caption: photo.caption, image: image(photo.imageKey, photo.alt), category: photo.category, event: photo.event, order: photo.order })) as GalleryPhotoContent[],
  givingMethods: [
